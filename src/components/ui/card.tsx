...
/** Glass surface used across marketing and dashboard. */
...
>(({ className, interactive, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "glass edge-light relative overflow-hidden rounded-2xl text-card-foreground shadow-soft",
      interactive &&
        "transition-all duration-300 ease-premium hover:border-white/[0.14] hover:shadow-lifted",
      className,
    )}
    {...props}
  />
